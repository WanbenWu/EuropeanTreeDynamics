...
for (i in 1:n_runs) {
  ...
  write.csv(plot_data_AMT_all, "~out/Response_Curve_AMT_MeanTCtrend_99runs.csv")
  write.csv(plot_data_ATP_all, "~out/Response_Curve_ATP_MeanTCtrend_99runs.csv")
  write.csv(plot_data_DEM_all, "~out/Response_Curve_DEM_MeanTCtrend_99runs.csv")
  write.csv(plot_data_Slope_all, "~out/Response_Curve_Slope_MeanTCtrend_99runs.csv")
  write.csv(plot_data_DroughtIntensity_all, "~out/Response_Curve_DroughtIntensity_MeanTCtrend_99runs.csv")
  write.csv(plot_data_WildfireIntensity_all, "~out/Response_Curve_WildfireIntensity_MeanTCtrend_99runs.csv")
  write.csv(plot_data_WindstormIntensity_all, "~out/Response_Curve_WindstormIntensity_MeanTCtrend_99runs.csv")
  write.csv(plot_data_FormalCroplandFraction_all, "~out/Response_Curve_FormalCroplandFraction_MeanTCtrend_99runs.csv")
  write.csv(plot_data_ProtectionAreaFraction_all, "~out/Response_Curve_ProtectionAreaFraction_MeanTCtrend_99runs.csv")
  write.csv(plot_data_ForestManagementIntensity_all, "~out/Response_Curve_ForestManagementIntensity_MeanTCtrend_99runs.csv")
  write.csv(plot_data_Accessibility2City_all, "~out/Response_Curve_Accessibility2City_MeanTCtrend_99runs.csv")
  write.csv(plot_data_DePOPfraction_all, "~out/Response_Curve_DePOPfraction_MeanTCtrend_99runs.csv")

...
data_folder <- "~data/Tree Connectivity Index/Geotiff"
...
save(ARfit, file = "~out/PARTS Trend/partTCIARfit.rda")
...
writeRaster(trend_raster, "~out/partitioned_TCI_trend.tif", overwrite = TRUE)
writeRaster(pvalue_raster, "~out/partitioned_TCI_trend_pvalue.tif", overwrite = TRUE)

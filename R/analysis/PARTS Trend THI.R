...
data_folder <- "~data/Tree Heterogeneity Index/Geotiff"
...
save(ARfit, file = "~out/PARTS Trend/partTHIARfit.rda")
...
writeRaster(trend_raster, "~out/partitioned_THI_trend.tif", overwrite = TRUE)
writeRaster(pvalue_raster, "~out/partitioned_THI_trend_pvalue.tif", overwrite = TRUE)
